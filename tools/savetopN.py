...
def main():
    ...
    for i in range(len(partitions)):
        ...
        savenewcleans = f'/mnt/scratch/ande2472/data/{startnum}_topjournals/{startnum}to{endnum}_topjournals_cleans.pickle'
        savenewembs = f'/mnt/scratch/ande2472/data/{startnum}_topjournals/{startnum}to{endnum}_topjournals_embs.pickle'
        savenewfile = f'/mnt/scratch/ande2472/data/{startnum}_topjournals/{startnum}to{endnum}_topjournals.csv'
